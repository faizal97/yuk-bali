...
<div class="container-fluid">
	<h1 class="animated fadeInDown"><?php echo $judul_rek1 ?></h1>
	<div class="row">
	<?php $no=0;$no++;foreach ($data_kursus->result() as $row) {$nama_pengajar=$row->nama_depan." ".$row->nama_belakang;$no++;?>
		...
		<div id="jelajah<?php echo $no ?>" class="card animated zoomIn">
         <img class="card-img-top img-thumbnail" src="<?php echo base_url($row->gambar_kursus) ?>?<?php echo time() ?>" width="300px" height="250px" alt="Card Image">
         <div class="card-body">
	...
	<br>
	<h1 class="animated fadeInDown"><?php echo $judul_rek2 ?></h1>
	<div class="row">
