<div class="container">
	<h1 class="display-4 text-center animated slideInDown">Hasil Dari :<?php echo $_GET['q'] ?></h1>
...
<br><br>
	...
	<div class="row" style="margin-bottom:20px">
		...
		<div class="col animated jackInTheBox">
			...
			<a class="btn btn-success form-control h-30" style="font-size:18pt" href="<?php echo base_url('masuk.html') ?>">DAFTAR</a>
		</div>
	</div>
	<?php } ?>
</div>
