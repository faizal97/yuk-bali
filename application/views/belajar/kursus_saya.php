	...
	<div class="card">
		...
		<div class="card">
         ...
         <div class="card-body">
			 ...
			 ?>
			 	<div class="progress-bar" role="progressbar" style="width: <?php echo $kursus_progress ?>%" aria-valuenow="<?php echo $kursus_progress ?>" aria-valuemin="0" aria-valuemax="100"><?php echo $row->materi_terakhir ?>&nbsp;/&nbsp;<?php echo $row->jumlah_materi ?>&nbsp;Materi</div>
			 </div>	 
         </div>
        </div>
		</a>
